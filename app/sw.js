...
const DB_HASH = "estudios-fyq-v2"; // bump when data/db.js content changes
const SHELL_VER = "v6";     // bump when html/css/js/icon URLs change to invalidate the shell cache
